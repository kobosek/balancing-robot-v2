...
struct SystemBehaviorConfig {
    ...
    int imu_max_sample_age_ms = 20;
    int imu_reconnect_interval_ms = 1000;
    ...
    bool operator!=(const SystemBehaviorConfig& other) const {
        return joystick_deadzone != other.joystick_deadzone ||
               ...
               imu_max_sample_age_ms != other.imu_max_sample_age_ms ||
               imu_reconnect_interval_ms != other.imu_reconnect_interval_ms;
    }
